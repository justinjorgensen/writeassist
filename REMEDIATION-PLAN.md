...
- [ ] **R-10: Propagate the v2 engine everywhere (D1, D3).**
...
- [ ] **R-11: One critic output schema, declared in every reviewer agent.**
...
- [ ] **R-12: Spawn named read-only agents in review-chapter (D6).**
...
- [ ] **R-13: Make the em-dash guard actually block (PreToolUse).**
...
- [ ] **R-20: Delete orphaned agents; demote the roster (D4, D5).**
