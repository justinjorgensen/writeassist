...
QUALITY GATES:
- Every chapter must pass the review panel
- Critical chapters (1, 10, 20): Pass on all gating critics
...
theme-explorer reviewing depth...
...
7. Delivers a panel-passed manuscript
...
- ✓ Agent review passed (panel-passed)
