...
## Tie-in with the daily smart-review cron

The daily `/smart-review` cron (see `cron-setup.md`) checks Calendar for that day's writing block. If a block exists and no chapter was modified during it, it surfaces a gentle nudge via PushNotification.
